...
export function generateIndoor(SHELFMODEL_PATH, SHELFMODEL_NAME, BOXMODEL_PATH, BOXMODEL_NAME, cameraObject, scene) {
    ...
    const WAREHOUSEMODEL_PATH = "../lib_obj/_warehouse_OBJ3/"
    const WAREHOUSEMODEL_NAME = "warehouse.gltf";
    const SHELFMODEL_PATH = "../lib_obj/etagere/files/";
    const SHELFMODEL_NAME = "etagere.stl";
    const BOXMODEL_PATH = "../lib_obj/Wooden Crate/"
    const BOXMODEL_NAME = "Wooden Crate.stl";
    const FORKLIFT_PATH = "../lib_obj/forklift/";
    const FORKLIFT_NAME = "Forklift.obj";

    generateModels(BOXMODEL_PATH, BOXMODEL_NAME, SHELFMODEL_PATH, SHELFMODEL_NAME, scene);
